...
sed -i 's/MCMCtree\/HYPOTHESIS/MCMCtree\/HYPOTHESIS\_'${change}'/' $out_file
else
...
sed -i 's/HYPOTHESIS/'${hypothesis}'/g' $out_file
sed -i 's/CMDRUN/'${runmcmc}'/' $out_file
sed -i 's/NUMCH/'${nch}'/' $out_file
