...
path_prior <- c( paste( home_dir,
                        "../00_MCMCtree/sum_analyses/00_prior/dRetal15pUhb_NODAT_GBM/",
                        sep = "" ),
                 paste( home_dir,
                        "../00_MCMCtree/sum_analyses/00_prior/dRetal15pUhb_NODAT_ILN/",
                        sep = "" ),
                paste( home_dir,
...
sum_prior_QC$`Unconstrained-NODAT-GBM`$num_chains # 4
...
sum_prior_QC$`Unconstrained-NODAT-ILN`$num_chains # 5

## [[ PostKPg-NODAT-GBM -- no data ]] ####
sum_prior_QC$`UpperEdiacaran-NODAT-GBM`$ESS_results
# $median
# [1] 20001
# 
# $min
...
# $total_samples
# [1] 40002    53
length( sum_prior_QC$`UpperEdiacaran-NODAT-GBM`$not_conv_nodes ) # 0
sum_prior_QC$`UpperEdiacaran-NODAT-GBM`$num_chains # 2

## [[ UpperEdiacaran-NODAT-ILN -- no data ]] ####
sum_prior_QC$`UpperEdiacaran-NODAT-ILN`$ESS_results
# $median
# [1] 20001
# 
# $min
...
# $total_samples
# [1] 120006     53
length( sum_prior_QC$`UpperEdiacaran-NODAT-ILN`$not_conv_nodes ) # 0
sum_prior_QC$`UpperEdiacaran-NODAT-ILN`$num_chains # 6
