          seed = -1
       seqfile = /data/scratch/btx126/modsel_animals_b128/alignments/2/aln_part2.phy
      treefile = /data/scratch/btx126/modsel_animals_b128/trees/uncalibrated/uncalib_animal.tree
      mcmcfile = mcmc.txt
       outfile = out.txt
    ...
    aaRatefile = /data/scratch/btx126/modsel_animals_b128/control_files/lg.dat   * Path to the file with the LG matrix
