...
delcol_post <- 8 # There are 4 partitions, and hence 8 columns (we ran
...
all_paths <- c( paste( home_dir,
                       "../00_MCMCtree/sum_analyses/01_posterior/ACetal22_GBM/",
                       sep = "" ),
                paste( home_dir,
                       "../00_MCMCtree/sum_analyses/01_posterior/ACetal22_ILN/",
                       sep = "" ),
                paste( home_dir,
...
# Save object! -- it is a very big file (~5.4Gb), so only run the commands below
...
# $total_samples
# [1] 80004    71
length( sum_post_QC$`Unconstrained-GBM`$not_conv_nodes ) # 14
sum_post_QC$`Unconstrained-GBM`$num_chains # 4
...
# $total_samples
# [1] 120006     71
length( sum_post_QC$`Unconstrained-ILN`$not_conv_nodes ) # 3
sum_post_QC$`Unconstrained-ILN`$num_chains # 6

## [[ PostKPg-GBM ]] ####
sum_post_QC$`PostKPg-GBM`$ESS_results
# $median
# [1] 20001
# 
# $min
...
# $total_samples
# [1] 100005     71
length( sum_post_QC$`PostKPg-GBM`$not_conv_nodes ) # 18
sum_post_QC$`PostKPg-GBM`$num_chains # 5

## [[ PostKPg-ILN ]] ####
sum_post_QC$`PostKPg-ILN`$ESS_results
# $median
# [1] 20001
# 
# $min
...
# $total_samples
# [1] 120006     71
length( sum_post_QC$`PostKPg-ILN`$not_conv_nodes ) # 10
sum_post_QC$`PostKPg-ILN`$num_chains # 6
